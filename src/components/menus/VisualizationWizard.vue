...
const selectedLobLineOptions = ref(null)
...
function createVisualization() {
  ...
  switch (newViz.type) {
    ...
    case 'pointmarker':
      ...
      break;
    case 'lob':
      const lobResult = CreateLOBViewProps(selectedDatastream.value, selectedMarkerProperty.value, selectedLOBProperty.value, selectedLobLineOptions.value, vizStore.currentVisDataStreamOptions)
      visualizationComponents = {
  ...
  <v-card class="pa-4 vwizard-card" elevation="4">
    ...
    <div v-else-if="step === 1">
      ...
      <div v-else-if="selectedType === 'lob'">
        ...
        v-model:selectedLobProps = "selectedLobLineOptions" 
        />
      </div>
